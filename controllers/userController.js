...
const userSignUpPost = asyncHandler(async (req, res, next) => {
	...
	const handleSignUp = () => {
		...
		bcrypt.hash(user.password, randomSalt, async (err, hashedPassword) => {
			...
			const handleAddUser = async () => {
				...
				passport.authenticate("local", (err, userId) => {
					err && next(err);
